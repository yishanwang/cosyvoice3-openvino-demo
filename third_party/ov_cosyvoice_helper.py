...
#   https://github.com/openvinotoolkit/openvino_notebooks/blob/latest/notebooks/cosyvoice3-tts/ov_cosyvoice_helper.py
#   (openvinotoolkit/openvino_notebooks PR #3243, "add Cosyvoice-3 notebook")
# Copyright (c) openvinotoolkit contributors. Licensed under the Apache
# License, Version 2.0 (see LICENSE / http://www.apache.org/licenses/LICENSE-2.0).
# This is the official, community-reviewed reference conversion for this
# exact model -- used here as-is via convert_full_pipeline_official.py
# rather than re-implemented. See README.md for why this is the recommended
# path over the from-scratch scripts/ in this repo.
import sys
